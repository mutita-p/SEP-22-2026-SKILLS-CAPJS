...
context master {
    entity BusinessPartners {
        ...
        BP_ROLE : cmn.Role          @(title: '{i18n>BP_ROLE}');
    ...
    entity Product {
        ...
        TYPE_CDOE : String(2)       @(title: '{i18n>TYPE_CDOE}');    
